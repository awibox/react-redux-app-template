                ...
                return (
                    <div key={repo.id} className={styles.item}>
                        ...
                        <div className={styles.panel}>
                            ...
                            <div className={styles.property}><i className="fa fa-file-archive-o"></i> {(repo.size / 1024).toFixed(2)} mb</div>
                            <div className={styles.property}><i className="fa fa-star" aria-hidden="true"></i> {repo.stargazers_count}</div>
                        </div>
                    </div>
                );
            })}
